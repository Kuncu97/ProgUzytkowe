...
\begin{itemize}
    ...
    \item studia drugiego stopnia – magisterskie (4 sem.), sp. nauczanie matematyki, matematyka stosowana oraz studia niestacjonarne:
\end{itemize}
...
wraz z powołaniem w 1950 roku Zakładu Matematyki w Zespołowej Katedrze Fizyki, a od 1951 roku – Katedry Statystyki Matematycznej ówczesnej Wyższej Szkoły Rolniczej, przemianowanej w 1972 r. na
...
\textbf{Przypisy}
\begin{enumerate}
    \item Wydział Matematyki i Informatyki UWM w Olsztynie, Oferta kształcenia (http://wmii.uwm.edu.pl/wydzial/oferta-ksztalcenia). [dostęp 2016-10-12].
    \item Wydział Matematyki i Informatyki UWM w Olsztynie, Akredytacja (http://wmii.uwm.edu.pl/wydzial/akredytacja) . [dostęp 2016-10-13].
    \item Wydział Matematyki i Informatyki UWM w Olsztynie\newline
    (http://wmii.uwm.edu.pl/index.php?content=uprawnienia)\newline\newline
\end{enumerate}
\textbf{Linki zewnętrzne}
\begin{itemize}
